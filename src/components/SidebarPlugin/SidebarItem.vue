  ...
  >
    ...
    <collapse-transition>
      <div
        ...
        class="collapse show"
      >
        <ul v-for="(lien, index) in link.children" :key="index" class="nav nav-sm flex-column " :class="{ active: isActive }">
          <li class="nav-item" >
            <a :href=" '#' + lien.link.path" class="nav-link">
<!--              <span class="sidenav-mini-icon">O</span>-->
              <span class="sidenav-normal">{{ lien.link.name }}</span>
            </a>
          </li>
        </ul>
      </div>
...
export default {
  ...
  created() {
    if(this.link.children){
      console.log('CHILDREEN', this.link);
