        ...
        <b-card-header class="border-0">
          <b-row>
            ...
            <b-col class="col-6 text-right">
              <base-button v-if="checkPermission(['creer type_offre'])" icon @click="handleAdd" variant="primary" size="sm" type="primary">
            ...
            <el-table-column label="Action"
              ...
              <template v-slot="{row}">
                <span class="text-sm">
                  ...
                  <a v-if="checkPermission(['modifier type_offre'])" href="#" class="mx-1" data-bs-toggle="tooltip" data-bs-original-title="Edit product" @click="handleEdit(row.id)">
                    <i class="fas fa-user-edit text-secondary" aria-hidden="true"></i>
                  </a>
                  <a v-if="checkPermission(['supprimer type_offre'])" href="javascript:;" class="mx-1"  data-bs-toggle="tooltip" data-bs-original-title="Delete product">
